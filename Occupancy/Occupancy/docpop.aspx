<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="docpop.aspx.cs" Inherits="Occupancy.docpop" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <h3 class="card-title">Edit/Add Documents</h3>
</asp:Content>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

     <form id="form1" runat="server" style="height: 955px; width: 1187px">
        <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=ComplianceEntities4" DefaultContainerName="ComplianceEntities4" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="TBL_MST_DOCUMENT_TYPES">
  ...
  <asp:Panel ID="panelAddNew" runat="server" style="display:none; background-color:gray;" ForeColor="Black" Width="500" Height="300">
            ...
            <table style="width:100%; padding:5px;">
                ...
                <tr>
                    <td><b>Enter Document Type ID</b></td>
                    <td><b>:</b></td>
                ...
                <tr>
                    <td><b>Enter Document Type Name</b></td>
                    <td><b>:</b></td>
                ...
                <tr>
                    <td><b>Enter Document Type Details</b></td>
                    <td><b>:</b></td>
            ...
            <table style="width:100%; padding:5px;">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtName2" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfv5" runat="server" ControlToValidate="txtName2" Display="None" ErrorMessage="Enter ID"  ValidationGroup="edit"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtJob2" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfv6" runat="server"  ControlToValidate="txtJob2" Display="None" ErrorMessage="Enter Name" ValidationGroup="edit"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtSal2" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfv7" runat="server" ControlToValidate="txtSal2" Display="None" ErrorMessage="Enter Details" ValidationGroup="edit"></asp:RequiredFieldValidator>
