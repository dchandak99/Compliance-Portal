...
namespace Occupancy
{
    public partial class catpop : System.Web.UI.Page
    {
        ...
        {
            sqlQry = "select * from tbl_mst_categories";
        ...
        protected void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            string cmdString = "SET IDENTITY_INSERT TBL_MST_CATEGORIES ON INSERT INTO TBL_MST_CATEGORIES(id, category_id, category_name, category_details, isactive) VALUES (@id,@catid,@catname,@catdet, 1)";
            try
            {
                ...
                cmd.Parameters.AddWithValue("@catid", txtName1.Text);
                cmd.Parameters.AddWithValue("@catname", txtJob1.Text);
                cmd.Parameters.AddWithValue("@catdet", txtSal1.Text);
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlQry = "select id,category_id, category_name,category_details, isactive from tbl_mst_categories where id=" + tempID;
                if (cn.State != ConnectionState.Open)
                    cn.Open();
                ...
                {   
                    ...
                    txtName2.Text = dr["category_id"].ToString();
                    txtJob2.Text = dr["category_name"].ToString();
                    txtSal2.Text = dr["category_details"].ToString();
        ...
        {   
            ...
            string cmdString = "UPDATE TBL_MST_CATEGORIES SET CATEGORY_ID = @catid, CATEGORY_NAME = @catname, CATEGORY_DETAILS = @catdet Where ID=@id";
            ...
            try
            {
              ...
              //  cmd.Parameters.AddWithValue("@catid", Convert.ToInt16(ViewState["tempId"].ToString()));
                cmd.Parameters.AddWithValue("@catid", txtName2.Text);
                cmd.Parameters.AddWithValue("@catname", txtJob2.Text);
                cmd.Parameters.AddWithValue("@catdet", txtSal2.Text);
                cmd.Parameters.Add("@id", SqlDbType.Int);
